...
const Icons = {
  ...
  python: () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <path
        fill="#ffffff"
        d="M18.287 6.119v2.542a3.672 3.672 0 0 1-3.572 3.63H8.991A2.922 2.922 0 0 0 6.129 15.2v5.453c0 1.551 1.349 2.464 2.862 2.91c.855.277 1.839.437 2.86.437s2.005-.16 2.927-.456l-.068.019c1.44-.417 2.862-1.258 2.862-2.91v-2.184h-5.719v-.727h8.582c1.664 0 2.284-1.161 2.863-2.902c.28-.87.441-1.871.441-2.91s-.161-2.04-.46-2.979l.019.07c-.411-1.656-1.2-2.902-2.863-2.902zm-3.216 13.807h.017a1.091 1.091 0 1 1-1.091 1.091v-.011c0-.595.48-1.077 1.074-1.08z"
      />
    </svg>
  ),
  expo: () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 457 512">
      <path
        fill="#ffffff"
        d="M365.908 248.585c34.205 2.347 61.615-19.737 68.687-50.188c-12.398-17.568-38.4-25.911-61.335-11.355c-20.62 14.6-26.246 40.125-7.352 61.543zM273.305 10.732L149.51 79.105l28.627 15.02L301.826 25.96l-28.521-15.229zM155.843 198.79l120.942 275.98l32.289 19.834l-135.228-391.687l-32.211-17.27L12.87 328.604l23.497 13.187l110.998-144.02c2.428-2.719 6.49-2.807 8.478 1.02zm215.989 65.621c-35.172-19.361-35.172-68.029 0-87.39s79.376 4.971 79.376 43.695s-44.204 63.057-79.376 43.695zm39.955 36.412l45.06 131.37L319.247 512l-50.638-31.43l-90.68-206.734l-140.32 79.052L0 331.738L136.077 75.793L273.112 0l42.704 22.937l43.241 126.422c-83.56 46.07-41.566 162.873 52.73 151.464z"
      />
    </svg>
  ),
  express: () => (
